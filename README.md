...
**Built for [The Coding Kitty Hackathon](#) — #hackthekitty**
...
1. In-game, click **Save Code** (top bar). A code is generated — copy it somewhere safe.
...
- **No framework, no build step** — vanilla HTML/CSS/JS, opens straight from disk.
...
- Save codes are a few KB of plain text — functional, not pretty.
...
No license specified yet — all rights reserved by default until one is added. (Add an MIT/Apache-2.0/etc. `LICENSE` file here if you want this open for reuse.)
